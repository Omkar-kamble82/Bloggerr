...
import { GetTagBlogs } from "../firebase/functions"
...
const Category = () => {
    ...
    const getblog = async () => {
        try {
            if (category){
                const bloglist = await GetTagBlogs(category)
    ...
    return (
        <div>
            ...
            <>           
                <h1 className="text-center mb-[20px] font-bold text-[60px] font">{category} Blogs</h1>
